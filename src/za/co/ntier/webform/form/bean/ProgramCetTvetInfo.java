...
public class ProgramCetTvetInfo {
	...
	public ProgramCetTvetInfo(MenuContextInfo menuContextInfo) throws NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		if (menuContextInfo.getProgramType() == ProgramType.CET) {
			annexure = AnnexureInfo.getAnnexureInfoOneLine(AnnexureInfo.class, "ANNEXURE A (Applicable to CET Colleges)", 
			...
			annexure = AnnexureInfo.getAnnexureInfoOneLine(AnnexureInfo.class, "ANNEXURE B (Applicable to CET Colleges)", 
					List.of(ColumnInfo.getColLabel("Name of the Intervention"),
							ColumnInfo.getColPositiveNumber("Number of beneficiaries applying for"),
			...
			annexure = AnnexureInfo.getAnnexureInfoOneLine(AnnexureInfo.class, "ANNEXURE C (Applicable to CET Colleges)", 
					List.of(ColumnInfo.getColLabel("Name of the Intervention"),
							ColumnInfo.getColPositiveNumber("Number of beneficiaries applying for")
							), 
			...
			annexure = AnnexureInfo.getAnnexureInfoOneLine(AnnexureInfo.class, "ANNEXURE D (Applicable to CET Colleges)", 
					List.of(ColumnInfo.getColLabel("Name of the Intervention"),
							ColumnInfo.getColPositiveNumber("Number of beneficiaries applying for")
							), 
			...
			annexure = AnnexureInfo.getAnnexureInfoOneLine(AnnexureInfo.class, "ANNEXURE E (Applicable to TVET Colleges)", 
					List.of(ColumnInfo.getColLabel("Name of the Intervention"),
							ColumnInfo.getColPositiveNumber("Number of beneficiaries applying for"),
							ColumnInfo.getColPositiveNumber("Discipline Applying For")
							), 
			...
			annexure = AnnexureInfo.getAnnexureInfoOneLine(AnnexureInfo.class, "ANNEXURE F  (Applicable to TVET Colleges)", 
					List.of(ColumnInfo.getColLabel("Name of the Intervention"),
							ColumnInfo.getColPositiveNumber("Number of beneficiaries applying for"),
			...
			annexure = AnnexureInfo.getAnnexureInfoOneLine(AnnexureInfo.class, "ANNEXURE G (Applicable to TVET Colleges)", 
					List.of(ColumnInfo.getColLabel("Name of the Intervention"),
			...
			subAnnexure = AnnexureInfo.getAnnexureInfoOneLine(AnnexureInfo.class, "Please supply the list of possible fields of study for this WIL", 
					List.of(ColumnInfo.getColPositiveNumber("Field of Study:"),
			...
			annexure = AnnexureInfo.getAnnexureInfoOneLine(AnnexureInfo.class, "ANNEXURE H (Applicable to TVET Colleges)", 
					List.of(ColumnInfo.getColLabel("Name of the Intervention"),
							ColumnInfo.getColPositiveNumber("Total Number of beneficiaries applying for")
							), 
			...
			annexure = AnnexureInfo.getAnnexureInfoOneLine(AnnexureInfo.class, "ANNEXURE I (Applicable to TVET Colleges)", 
					List.of(ColumnInfo.getColLabel("Name of the Intervention"),
