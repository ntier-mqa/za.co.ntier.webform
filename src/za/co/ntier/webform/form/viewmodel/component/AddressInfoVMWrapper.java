...
public class AddressInfoVMWrapper extends ComponentVMWrapper<AddressInfo>{
	...
	private boolean relaxedConstraints = false;

    @Init(superclass = true)
    public void init(@ExecutionArgParam("relaxedConstraints") Boolean relaxedConstraints) {
        // this will also call @Init in ComponentVMWrapper because of superclass = true
        this.relaxedConstraints = relaxedConstraints != null && relaxedConstraints;
    }

    public boolean isRelaxedConstraints() {
