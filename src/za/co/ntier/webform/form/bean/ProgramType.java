...
public enum ProgramType {
	CANDIDACY("CANDIDACY"), INTERNSHIP("INTERNSHIP"), EXPERIENCE("EXPERIENCE"), DEV_PROGRAM("DEVELOPMENT PROGRAMM"),
	ARTISAN_AIDES("ARTISAN AIDES"), ARTISAN_DEV("ARTISAN DEVELOPMENT"),
	CENTRE_SPECIALISATION("CENTRE OF SPECIALISATION"), ARTISAN_RPL("ARTISAN RPL"),
	NON_ARTISAN_DEV("NON-ARTISAN DEVELOPMENT"), NON_ARTISAN_DEV_RPL("NON-ARTISAN DEVELOPMENT RPL"),
	NCV_GRADUATES("NCV LEVEL 4 GRADUATES"), AET("AET"), OHASSP("OCCUPATIONAL HEALTH AND SAFETY SKILLS PROGRAMMES"),
	INHOUSE_TRAINING("IN-HOUSE TRAINING"), TVET_BURSARS("TVET_BURSARS"), CET("CET"), TVET("TVET"),
