...
public class WebForm extends ADForm{
	...
	protected void initForm() {
		...
		// Set the context class loader to this bundle's class loader to ensure that classes provided by the bundle (e.g., za.co.ntier.webform.form.viewmodel.*) used in ZUL files can be found.
