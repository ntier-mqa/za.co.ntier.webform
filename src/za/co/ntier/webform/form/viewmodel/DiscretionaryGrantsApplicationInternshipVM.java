...
public class DiscretionaryGrantsApplicationInternshipVM {
    private AddressInfoBase internshipContact;
    private AddressInfoBase alternateInternshipContact;
    ...
    public DiscretionaryGrantsApplicationInternshipVM() throws IOException {
        // Initialize with default values if needed
        setCompanyInfo(CompanyInfo.getDefaultCompanyInfo());
        setFormInfo(new FormInfo("DGA INTERNSHIP", "DGAF02"));
        ...
        internshipContact = new AddressInfoBase(AddressCategory.CANDIDACY_CONTACT, MasterUtil.getRegions().get(new Random().nextInt(MasterUtil.getRegions().size())));
        alternateInternshipContact = new AddressInfoBase(AddressCategory.CANDIDACY_CONTACT, MasterUtil.getRegions().get(new Random().nextInt(MasterUtil.getRegions().size())));
    ...
    /**
     * @return the internshipContact
     */
    public AddressInfoBase getInternshipContact() {
        return internshipContact;
    }
    ...
    /**
     * @param internshipContact the internshipContact to set
     */
    public void setInternshipContact(AddressInfoBase internshipContact) {
        this.internshipContact = internshipContact;
    }
    ...
    /**
     * @return the alternateInternshipContact
     */
    public AddressInfoBase getAlternateInternshipContact() {
        return alternateInternshipContact;
    }

    /**
     * @param alternateInternshipContact the alternateInternshipContact to set
     */
    public void setAlternateInternshipContact(AddressInfoBase alternateInternshipContact) {
        this.alternateInternshipContact = alternateInternshipContact;
    }
