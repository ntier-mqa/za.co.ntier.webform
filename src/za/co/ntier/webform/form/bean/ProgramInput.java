...
public class ProgramInput extends AnnexureInfo {
	...
	public static ProgramInput getTrade(int programMasterDataID, String tableTitle) throws NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		return ProgramInput.getTradeDiscipline(true, programMasterDataID, tableTitle);
	}
	
	public static ProgramInput getDisciplines(int programMasterDataID, String tableTitle) throws NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		return ProgramInput.getTradeDiscipline(false, programMasterDataID, tableTitle);
	}
	
	@SuppressWarnings("unchecked")
	private static ProgramInput getTradeDiscipline(boolean isTrade, int programMasterDataID, String tableTitle) throws NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
